// src/pages/ImageCapturePage.tsx
    ...
    <div className="px-40 flex flex-1 bg-[#1b2427] justify-center py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        ...
        <p className="text-white text-base font-normal leading-normal pb-3 pt-1 px-4">
          Upload an image to analyze the emotions of the people in it. Our
          advanced AI will detect faces and provide an emotional score for each
          person.
        </p>
        ...
        <div className="flex px-4 py-3 justify-center">
          <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#38e07b] text-[#122118] text-sm font-bold leading-normal tracking-[0.015em]">
        ...
        <div className="flex w-full grow bg-[#122118] @container p-4">
          <div className="w-full gap-1 overflow-hidden bg-[#122118] @[480px]:gap-2 aspect-[3/2] rounded-lg flex">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBnvrkV80AVidNmLuClJJLl58pv3RRpqq5pP-FwAosFhyHzpAokGY1ooc1wSdZiyaEglpZBqULc1yxvC99rMwUKwGIV70_wVJodgwIk2vI0HPKDq2dpsSTJjLkQvaoPexoJGW_4qi3aD0p1ExOzfs4QCBMR3PuaWvf3Doj6j5zT2ugZgxOZh8PNlsbTZ5YmefmEaVe8WDDKmS6wcgQngTaq51z50BQMoFe_z84hPAO6ZSkU3KVBuNeUs91V-II7X4g8T12qkb2sYBk")',
              }}
            ></div>
          </div>
        </div>
            ...
            <table className="flex-1">
              <thead>
                <tr className="bg-[#1b3124]">
                  <th className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-56 px-4 py-3 text-left text-white w-14 text-sm font-medium leading-normal">
                    Face
                  </th>
                  <th className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-176 px-4 py-3 text-left text-white w-[400px] text-sm font-medium leading-normal">
                    Emotion
                  </th>
                  <th className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-296 px-4 py-3 text-left text-white w-[400px] text-sm font-medium leading-normal">
                    Score
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-t-[#366348]">
                  ...
                  <td className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-296 h-[72px] px-4 py-2 w-[400px] text-[#96c5a9] text-sm font-normal leading-normal">
                    0.95
                  </td>
                </tr>
                <tr className="border-t border-t-[#366348]">
                  <td className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-56 h-[72px] px-4 py-2 w-14 text-sm font-normal leading-normal">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDufknFzruQ5-6hx-EAmOGpzARlPrY2MNd35Cr-Uu1YiaMNQI90aJ4ZHN4h6VnMpXIISljPn3CXN9tf5gxODzmr2ZPzBi7RlWofKqhHTWULYc9buMekX8gOsFG8xICZxLEr005JU2KX8FNiOy5oNS-SccVsWWcz2H-WpfwRDeAs1vw803dwIdrhn76N9XsDKAwF0-nEiV-HN_kYyqujTEiH2tjvUDeFbSAaIKAYS0r1jpTt5N3JuLJH_0RJfJ5Ejml1iEXOfKcc1fc")',
                      }}
                    ></div>
                  </td>
                  <td className="table-d7209287-1848-4a8b-9ada-0456c6c66db1-column-176 h-[72px] px-4 py-2 w-[400px] text-[#96c5a9] text-sm font-normal leading-normal">
